...
const noVideoTimeoutMS = 1000000; // Error alert if the video fails to connect

// Xirsys API Info, not required for WebRTC, but it helps
// Xirsys Network access tokens are issued via this PubNub Function
const turnApiUrl = 'https://ps.pndsn.com/v1/blocks/sub-key/sub-c-02b31e20-7357-11ea-bbea-a6250b4fd944/turn-credentials';
let turnToken;
...
getLocalStream().then((localMediaStream) => {
    ...
    console.log("Stream" + myAudioVideoStream)
...
const initWebRtcApp = () => {
            ...
            confirmCall(name).then((yesDoCall) => {
                if (yesDoCall) {
                    ...
                    request(turnApiUrl, 'PUT', {
                        ...
                        console.log(myAudioVideoStream);
    ...
    pubnub = new PubNub({
        publishKey : 'pub-c-9522c020-469c-42cc-b22b-f4df4e2f25fc',
        subscribeKey : 'sub-c-02b31e20-7357-11ea-bbea-a6250b4fd944'
    });
